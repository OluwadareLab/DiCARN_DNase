# DiCARN-DNase: DiCARN-DNase: Enhancing Cell-to-Cell Hi-C Resolution Using Dilated Cascading ResNet with Self-Attention and DNase-seq Chromatin Accessibility Data
...
**1.** Copy the exponential_linear_model_-0.4.Rdata file from this github repository root into your DNase base directory (base_path) defined in `DNase_imputation.R`

**2.** Simply run the command `Rscript DNase_imputation.R` to preprocess the DNase-seq data.
