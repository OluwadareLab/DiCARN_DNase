...
import Models.DiCARN_hybrid as DiCARN
import Models.HiCSR as HiCSR

from Models.DiCARN_hybrid import Generator
# from Models.HiCSR import Generator
...
def hicarn_predictor(model, hicarn_loader, ckpt_file, device, data_file):
	...
	deepmodel.eval()
	with torch.no_grad():
		for batch in tqdm(hicarn_loader, desc='HiCSR Predicting GM Repeat: '):
			lr, hr, inds = batch
